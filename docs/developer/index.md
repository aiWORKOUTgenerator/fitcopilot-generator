...
This section contains technical documentation for developers working with the FitCopilot Workout Generator plugin. Whether you're contributing to the core project or building integrations, you'll find detailed information about the architecture, API, components, and development practices.
...
- [Component Structure](./components/structure.md)
...
- [Data Flow](./state-management/data-flow.md)

### [Testing Guide](./testing/index.md)
- [Testing Strategy](./testing/strategy.md)
- [Frontend Tests](./testing/frontend.md)
- [Backend Tests](./testing/backend.md)
