...
class PromptBuilderController {
    ...
    public function enqueueAssets(string $hook_suffix): void {
        ...
        if (strpos($hook_suffix, 'prompt-builder') !== false || strpos($hook_suffix, 'fitcopilot-prompt-builder') !== false) {
            ...
            // CSS Modular Architecture - Load new modular CSS system
            wp_enqueue_style(
                'fitcopilot-prompt-builder-modular',
                plugins_url('assets/css/prompt-builder/index.css', FITCOPILOT_FILE),
                [],
                FITCOPILOT_VERSION . '-modular'
            );
            ...
            // Note: Using modular CSS system (assets/css/prompt-builder/index.css)
            // Legacy monolithic CSS files have been replaced with modular architecture
