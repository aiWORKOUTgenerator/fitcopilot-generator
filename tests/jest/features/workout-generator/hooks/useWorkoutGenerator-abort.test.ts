...
import { useWorkoutGenerator } from '../../../../../src/features/workout-generator/hooks/useWorkoutGenerator';
import * as useAbortControllerModule from '../../../../../src/features/workout-generator/hooks/useAbortController';

// Mock dependencies
jest.mock('../../../../../src/features/workout-generator/hooks/useAbortController', () => {
  const originalModule = jest.requireActual('../../../../../src/features/workout-generator/hooks/useAbortController');
  return {
    ...originalModule,
